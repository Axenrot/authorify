  ...
  return (
    <section className="relative flex-col h-[100vh] w-full flex items-center bg-black  bg-[url('/images/header-bg-transformed.jpeg')] justify-center ">
      ...
      <div className="px-3 items-center container mx-auto h-full blur-none py-12 flex flex-col gap-12 lg:flex-row">
        {/* hero message */}
        <div className="flex w-full  justify-center h-[30vh] lg:justify-start lg:w-1/2 lg:h-full text-center fadein">
        ...
        {/* hero image label */}
        <div className="relative z-20 flex w-full justify-center h-[70vh] lg:justify-center lg:w-1/2 lg:h-full fadein">
